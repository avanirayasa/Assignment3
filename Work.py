#  File: Work.py
#  Student Name: Avani Rayasa
#  Student UT EID: ar75487
#  Partner Name: Shreya Karthikeyan
#  Partner UT EID: sk57936
...
def sum_series(lines_before_coffee, prod_loss):
    if (lines_before_coffee // prod_loss == 0):
        ...
        return lines_before_coffee // prod_loss + sum_series(lines_before_coffee, prod_loss)
...
def linear_search(total_lines, prod_loss):
    ...
    for i in range(total_lines, 1):
        dict[i] = list(sum_series(i, prod_loss))
        numSumSeries += 1
